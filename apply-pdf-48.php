            ...
            <div class="card shadow-lg">
                <div class="card-body">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12">
                            <div class="mt-3">
                                <img class="rounded border" src="48-jubo-student/<?= $userpic; ?>" width="150" height="150" alt="Logo">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <table class="table mt-4 mb-5" id="certificateTable" style="font-size: 25px;">
                                <tbody>
                                    <tr>
                            ...
                            <p style="font-size: 25px;"> লিখিত পরীক্ষার তারিখ : ২৩ - মার্চ - ২০২৫ এবং মৌাখিক পরীক্ষার তারিখ: ২৫ শে মার্চ ২০২৫ । পরীক্ষার সময় ও স্থান, এসএমএস এর মাধ্যমে জানানো হবে। </p>
                            <div>
                              <span style="font-size: 25px; font-weight: 700;">শর্তাবলীঃ</span>
