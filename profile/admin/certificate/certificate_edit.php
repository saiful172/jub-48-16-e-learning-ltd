...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
        ...
        <td><input class="form-control" type="text" name="Father" value="<?php echo $father_name; ?>"  required></td>
    </tr>
	
	<tr>
    	<td><label class="control-label">  Mother Name  </label></td>
        <td><input class="form-control" type="text" name="Mother" value="<?php echo $mother_name; ?>"  required></td>
    </tr>
