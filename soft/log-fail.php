        ...
        <div class="container"> 
            <div class="workinghny-form-grid">
                <div class="main-mockup">
                    ...
                    <div class="content-wthree text-center"><br><br>
					<span style="color:blue; font-size:18px;"><img src="includes/dims.jpg" width="115px" /> </span>
                        <h2> Digital Invoice Manager </h2>  <br><br>
                          
                        <h2 class="alert alert-danger pt-4" style="width:90%;"> <span class="fa fa-exclamation-triangle"></span> Login Invalid </h2>
                       
						<br><br>
						<center><a href="index" style="width:50%;" class="btn btn-danger btn-block"><span class="fa fa-repeat"></span> Try again</a></center>
