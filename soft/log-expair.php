            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
					...
					<span style="color:blue; font-size:18px;"><img src="img/pay-itm.png" width="110px" /> </span>
                       <br> <h2> Easy Business Software </h2>  
					   <p>A Smart CRM Software</p>
					   <br><br>
                      <center>    
                        <h4 class="alert alert-danger pt-4" style="width:90%;font-size:15px;"> <span style="color:red;">Your Free Trial Is Expire</span><br>Or<br> Please Pay Your <b style="color:red;">Due Amount</b> ! And Then You Can Alow To <b style="color:green;">Use Software</b>. Or, Contact With Us </h4>
                        
						<a href="logout" style="width:50%;" class="btn  btn-danger btn-block"> Logout</a>
					</center>
