...
<div class="pagetitle">
      <h1>	  
		<?php if($_GET['o'] == 'add') { ?>
       <i class="glyphicon glyphicon-plus-sign"></i>  New Invoice - Retail  | <span> <a href="orders-retail?o=manord">   <i class="bi bi-table"></i> </a> </span>  
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Manage Invoice - Retail | <span> <a href="orders-retail?o=add">   <i class="bi bi-plus-square-fill"></i>  </a> 
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Edit Invoice - Retail | <span> <a href="orders-retail?o=manord">   <i class="bi bi-table"></i> </a> </span>  
		<?php } ?>
...
<div class="col-lg-4">	
        ...
        <input class="form-control" type="text" name="OrderId"    value="<?php echo $pqrow['user_id']; ?><?php echo $pqrow['max_id']; ?>100"  />
        </td>
		<?php }?>
