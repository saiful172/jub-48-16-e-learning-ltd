...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO account_balance_details (user_id,pre_balance,today_in,today_out,current_balance,payment_type,received_by,last_update,status) 
      VALUES(:UserId,:PreBalance,:TodayIn,:TodayOut,:CurBalance,:PayType,:ReceivedBy,:LastUpdate,:Status)');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>New Balance History | <span> <a href="balance-history"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
