...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Cash Balance | <span> <i class="bi bi-cash"></i> </span> </h1>
      <hr>
    </div>

    <section class="section dashboard">
      <?php require_once 'more-fals/cash-balance-dash.php'; ?>
    </section>
            ...
            <div class="card-body">
              ...
              <table class="table table-hover datatable">
                ...
                <tbody id="tbody">
                  <?php
                  $sl = 0;
                  $eq = mysqli_query($con, "SELECT * FROM account_balance_details WHERE user_id='" . $_SESSION['id'] . "' AND type = 1 ORDER BY ach_id DESC");
