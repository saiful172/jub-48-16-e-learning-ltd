...
<?php
			 ...
			 <?php echo $pqrow['business_name']; ?>  <br>
				   ...
				   <?php }?>
      <span style="font-size:19;"> Date Wise Leads Report</span>	<br>  
...
if($_POST) {
	...
	WHERE join_date >= '$start_date' AND join_date <= '$end_date' and phone_book.user_id='".$_SESSION['id']."'
	
	order by phone_book.lead_id desc";
	$query = $con->query($sql);
