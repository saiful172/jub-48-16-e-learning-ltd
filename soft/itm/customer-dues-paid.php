...
<body>
  ...
  ?>
        <script>
          ...
          window.location.href = 'customer-dues';
        </script>
  <?php
      } else {
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Pay Customer Dues | <span> <a href="customer-only-dues"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
                ...
                <table class="table table-hover table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" id="CustName1" name="CustName1" placeholder="Customer Name" value="<?php echo $CustName;  ?>" disabled="true" />
                      ...
                      <input class="form-control" type="hidden" id="Phone" name="Phone" placeholder="Phone Number" value="<?php echo $Phone; ?>" />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="hidden" id="PreDues1" name="PreDues1" placeholder="Previous Dues" value="<?php echo $PreDues; ?>" disabled="true" oninput="myFunctionRD()" />
                      <input class="form-control" type="text" id="PreDues" name="PreDues" placeholder="Previous Dues" value="<?php echo $PreDues; ?>" oninput="myFunctionRD()" />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <select class="form-control chosen-select" name="paymentType" id="paymentType">
  ...
  <script>
    $("#CustId").on("change", function() {
      ...
      if (customerID == "") {
        ...
        $.ajax({
          url: "ajax_c_load_dues_paid.php?c=" + customerID,
