        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">Profile Settings </h4></center>
                </div>
...
<div class="modal fade" id="Logo<?php echo $did; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Logo</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
                    <form role="form" method="POST" action="logo.php<?php echo '?id='.$did; ?>" enctype="multipart/form-data">
						<div class="container-fluid"> 
				  <div class="col-md-12"> 
				   		  
						<div style="height:15px;"></div>
						<center> 
						<img src="../<?php echo $dqrow['photo']; ?>" width="170" /><br>
						Logo ( Please Add 300 x 300px JPG or Png )</center>
						<div style="width:100%;" class="form-group input-group">
...
<div class="modal fade" id="SignImg<?php echo $did; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Signature</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
                    <form role="form" method="POST" action="signature.php<?php echo '?id='.$did; ?>" enctype="multipart/form-data">
						<div class="container-fluid"> 
				  <div class="col-md-12"> 
				   		  
						<div style="height:15px;"></div>
						<center> 
						<img src="../<?php echo $dqrow['sign_img']; ?>" height="80" width="200" /><br>
						Signature ( Please Add 250px x 80px JPG or Png )</center>
						<div style="width:100%;" class="form-group input-group">
                            <span style="width:120px;" class="input-group-addon">Logo</span>
	...
	<div class="modal fade" id="Lock<?php echo $did; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">Password</h4></center>
                </div>
                <div class="modal-body">
				<div class="container-fluid">
                    <form role="form" method="POST" action="lock.php<?php echo '?id='.$did; ?>" enctype="multipart/form-data">
						<div class="container-fluid"> 
				  <div class="col-md-12"> 
				   		  
						<div style="height:15px;"></div>
						<center> 
						<img src="../<?php echo $dqrow['photo']; ?>" width="150" /><br>
						</center>
