...
<div class="buttons">  
		<div class="col-md-12">
	   <a class="btn btn-primary btn-w100" href="sub-category-add"> <span class="glyphicon glyphicon-plus"></span> &nbsp;  Add New  </a> 
	   </div>
		 <br><br><br>
	   ...
	   <div class="col-md-12">
			<a class="btn btn-warning btn-w100" href="sub-category"> <span class="glyphicon glyphicon-list"></span> &nbsp;  Sub Category  </a> 
	   </div>
...
<table width="100%" class="table  table-bordered table-hover" group_id="dataTables-example">
				...
				<td><a  class="btn btn-info" href="sub-category-edit?edit_id=<?php echo $eqrow['sub_cat_id']; ?>" title="click for edit" 
                 onclick="return confirm('Do You Want To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
				
				<td><a class="btn btn-danger" href="?delete_id=<?php echo $eqrow['sub_cat_id']; ?>" title="click for delete" onclick="return confirm('Do You Want To Delete ?')"><span class="glyphicon glyphicon-remove-circle"></span> Delete </a> </td>
