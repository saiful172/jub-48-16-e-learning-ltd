...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>Dues Details |  <span> <a href="customer-only-dues">   <i class="bi bi-table"></i> </a> </span> </h1>
       <hr>
    </div> 
	...
	left join `payment_status` on payment_status.ps_id=orders_details.paym_type
	...
	?>
			...
			<td><?php echo $eqrow['custom_invoice']; ?>  </td> 
			<td> <a  target="_blank" href="due-paid-print?edit_id=<?php echo $eqrow['customer_id']; ?>"> <?php echo $eqrow['customer_name']; ?> - <?php echo $eqrow['address']; ?>   - <?php echo $eqrow['contact_info']; ?> </a></td> 
			...
			<td><?php echo $eqrow['paym_type']; ?>  </td>
