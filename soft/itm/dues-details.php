...
<center><h4><ol class="breadcrumb"> <li class="active">Customer Dues - Details </li></ol></h4></center>
		...
		<div class="col-md-12">
		<a class="btn btn-primary" style="width:100%" href="dues-paid"> <span class="glyphicon glyphicon-pencil"></span> Dues Paid</a> 
		</div>
		
		<div class="col-md-12">
		<a class="btn btn-primary" style="width:100%" href="dues"> <span class="glyphicon glyphicon-eye-open"></span> View Main Dues</a> 
		</div>
