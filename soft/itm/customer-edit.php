...
<center><h4><ol class="breadcrumb"> <li class="active">Customer Update</li></ol></h4></center>

<div class="col-md-2">
	<div class="buttons">
	
		<div class="col-md-12">
		<a class="btn btn-primary" style="width:100%" href="customer"> <span class="glyphicon glyphicon-user"></span> Client List  </a> 
		</div>
		 		
		<div class="col-md-12">
		<a class="btn btn-success" style="width:100%" href="customer-active-view"> <span class="glyphicon glyphicon-file"></span> All Customer Report </a> 
		</div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <a class="btn btn-danger" href="customer"> <span class="glyphicon glyphicon-backward"></span> Cancel</a>
