...
<center><h4><ol class="breadcrumb"> <li class="active">Product Return - Store</li></ol></h4></center>	
	  
		
	
    	<div class="div-action pull pull-left" style="padding-bottom:10px;">
	
			    <a href="product_return_add.php" class="btn btn-primary "> <i class="glyphicon glyphicon-backward"></i> Return  </a>
           </div> 
...
<table width="100%" class="table table-bordered" style="font-size:14px;">
		...
		where  product_details.user_id ='".$_SESSION['id']."' and product_details.type=3
