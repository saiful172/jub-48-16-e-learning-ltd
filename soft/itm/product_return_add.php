	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO product_details (user_id,invoice_no,brand_id,categories_id,product_id, quantity,  add_qty, rec_qty,rate,retail_rate, buy_rate,entry_date,cuses,type) 
			                                               VALUES(:UserId,:OrderId,:BrandId,:CategoriesId,:Product_Id, :Quantity, :RetQty,:RecQty, :SaleRate, :RetailRate, :BuyRate, :Date,"Return",3 )');
...
<center>  <h4><ol class="breadcrumb"> <li class="active"> Product Return</li></ol></h4> </center> 
 ...
 <h1 class="h2">
 <a class="btn btn-success" href="product_return.php"> <span class="glyphicon glyphicon-eye-open"></span> View </a>   
  </h1>    
...
<!-- Total  Product -->		
 <script>
  function myFunctionTP() {
    var x = Number (document.getElementById("RetQty").value);
