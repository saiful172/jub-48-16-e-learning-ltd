...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main1">
    ...
    <div class="pagetitle">
     <h1>Product Category |  <span> <a href="add-category">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table table-hover datatable">
				...
				<td><a  class="btn btn-info" href="edit-category?edit_id=<?php echo $eqrow['cat_id']; ?>" title="click for edit" 
