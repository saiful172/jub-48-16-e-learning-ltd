...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>Leads Category |  <span> <a href="lead-category-add">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
            ...
            <div class="card-body">
              ...
              <table class="table table-hover datatable">
               <thead>
				...
				<td><a  class="btn btn-info" href="lead-category-edit?edit_id=<?php echo $eqrow['pb_cat_id']; ?>" title="click for edit" 
