	  ...
	  $x = 1;
       ...
       $table .= '      
		...
		<tr style="border-top:1px solid gray;text-align:center;">   
            <td></td>		  
            <td class="center">Sub Total <br>'.$subTotal.'</td>
			<td class="center">Discount<br>'.$discount.'.00</td>
			<td class="center">Total<br>'.$TodayTotal.'.00</td>
			<td class="center">Previous Due<br>'.$PreDue.'.00</td>
			<td class="center">Courier Charge<br>'.$CuriCharg.'.00</td>
		</tr>
