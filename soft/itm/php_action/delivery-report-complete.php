...
<?php
 ...
 Daily Sales /  Delivery Complete Report<br>
</span> 
...
if($_POST) { 
	...
	WHERE orders.order_date >= '$start_date' AND orders.order_date <= '$end_date' and delivery_status=1 and orders.user_id='".$_SESSION['id']."'  order by orders.id desc";
	$query = $con->query($sql);
