...
WHERE orders.order_type = 1 and orders.order_status = 1  and orders.user_id ='".$_SESSION['id']."' order by orders.order_id desc ";
...
<li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile rounded">
            ...
            <li>
              <a class="dropdown-item d-flex align-items-center" href="orders.php?o=editOrd&i='.$orderId.'" >
                <i class="bi bi-pencil-square"></i>
                <span>Edit</span>
              </a>
            </li>
	...
	<div class="btn-group" style="display:none;">
	 ...
	 <ul class="dropdown-menu">
        ...
        <li><a href="return-orders-wsale.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Return </a></li>
