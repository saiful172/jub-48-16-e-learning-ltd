...
<?php
			 ...
			 <?php echo $pqrow['business_name']; ?>  <br>
				   ...
				   <?php }?>
      <span style="font-size:19;font-weight:bold;"> Daily Purchase Report</span> 
...
if($_POST) { 
	...
	WHERE order_date >= '$start_date' AND order_date <= '$end_date' and sup_orders_details.user_id='".$_SESSION['id']."'  order by sup_orders_details.id desc";
	$query = $con->query($sql);
