...
product.product_name,order_item.short_details,order_item.single_dis_taka,order_item.single_dis_prcnt,product.warranty,order_item.pro_qr_code ,brand1.brand_name,categories1.cat_name
FROM order_item
	  ...
	  <table border="0" cellspacing="0" cellpadding="0">
	   ...
	   <thead>
          <tr>
            ...
            <th class="qty"><b>Total.P</b></th>
            <th class="qty"><b>Dis / Dis %</b></th> 
	  ...
	  $x = 1;
		while($row = $orderItemResult->fetch_array()) {			
		 ...
		 <tbody>	
          <tr>
            <td class="no">'.$x.'</td>
            <td class="desc"><h3>'.$row[10].' - '.$row[4].' - '.$row[11].'</h3> <span style="font-size:14px;">Warranty : '.$row[8].' <br> QR Code : '.$row[9].'</span></td>
            <td class="unit">'.$row[2].'</td>
            <td class="qty">'.$row[1].'</td>
            <td class="qty">'.$row[1] * $row[2].'</td>
            <td class="qty">'.$row[6].' / '.$row[7].' x '.$row[2].' %</td> 
       ...
       $table .= '      
        ...
        <tfoot>
         ...
         <tr>		    
            <td class="btm-border-na"></td>
            <td class="btm-border-na"></td>
            <td class="btm-border-na"></td>
            <td class="btm-border"></td>  
            <td class="btm-border"></td>  
            <td>Grand Total Dis.Tk ( '.$DisTaka.' )  Dis.% ( '.$DisP.' ) =  </td>
            <td>'.$discount.'.00</td>
          </tr>	 
		 ...
		 <tr>
            ...
            <td class="btm-border-na"></td>
            <td class="btm-border"></td>
            <td>Pre.Due ( '.$PreDue.' ) + Courier ( '.$CuriCharg.' )  = </td>
            <td>'.$PreCur.'.00</td>
          </tr>	
