...
<?php
			 ...
			 <?php echo $pqrow['business_name']; ?>  <br>
				   ...
				   <?php }?>
      <span style="font-size:19;font-weight:bold;">  Date Wise Payment Report - Short</span> 
...
if($_POST) {
	...
	$sql = "SELECT * FROM sup_orders_details WHERE  order_date >= '$start_date' AND order_date <= '$end_date'  and  user_id='".$_SESSION['id']."' order by id desc ";
	$query = $con->query($sql);
	...
	<table width="100%" class="table table-bordered" >
     ...
     <tr>
		 <th colspan="7" style="font-size:17px; color:Green; "> Payment Report Short</th>
	    <tr>
		...
		<tr>
			<td colspan="8">  <center><b>Total = '.$countOrder.' |  Total Payment = '.$totalPaid.' </b> </center></td>
		</tr>
