...
<h4><ol class="breadcrumb"> <li class="active text-center"> Date Wise Single Customer Sales Report </li></ol></h4>
		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<div class="form-group">
				    <label for="startDate" class="col-sm-3 control-label">Customer By Name</label>
				    <div class="col-sm-9">
