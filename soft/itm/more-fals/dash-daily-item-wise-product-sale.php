    ...
    <div class="col-12">
        <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title"> Product Sale - Item wise <span> | <span class="text-danger"> <strong> Live Today </strong> </span>  </span> </h5> 
								...
								while($eqrow=mysqli_fetch_array($eq)){
									...
									?>
										<tr>
											...
											<td class="fw-bold"><?php echo $eqrow['rate'] * $eqrow['order_qty'] ; ?></td>  
