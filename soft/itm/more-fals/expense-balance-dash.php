  <div class="col-xxl-4 col-md-6">
    <div class="card info-card sales-card">
      ...
      <div class="filter">
        ...
        $CashAccId = $row['ac_id'];
        ?>
        <a class="icon" href="expenses-balance-edit?edit_id=<?php echo $CashAccId; ?>" data-bs-toggle="tooltip" data-bs-placement="top" title="Expenses"><i class="bi bi-bookmark-check"></i></a>
      ...
      <div class="card-body">
        <h5 class="card-title">Expense <span>| Balance</span></h5>
        <div class="d-flex align-items-center">
          ...
          <div class="ps-3">
            <h6>
              <?php
              $sql = $con->query("SELECT sum(`expense`) as cash_gtotal FROM expense where user_id='" . $_SESSION['id'] . "' ");
              $row = $sql->fetch_assoc();
