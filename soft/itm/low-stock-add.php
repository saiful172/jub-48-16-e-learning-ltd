...
<?php 
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO stock_low (user_id,low_qty,status) VALUES(:UserId,:Name,1)');
...
<center><h4><ol class="breadcrumb"> <li class="active"> Low Stock Add  </li></ol></h4></center>	

<div class="container">
<div class="col-md-7">

    	<h1 class="h2"> 
		<a class="btn btn-success" href="low-stock"> <span class="glyphicon glyphicon-eye-open"></span>  View</a></h1>
