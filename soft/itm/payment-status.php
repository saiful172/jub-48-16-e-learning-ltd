...
<center><h4><ol class="breadcrumb"> <li class="active">Payment Status </li></ol></h4></center>	

<div class="container"> 	  
	   
    	<div class="div-action pull pull-left" style="padding-bottom:8px;">
		<a class="btn btn-primary" href="payment-status-add"> <span class="glyphicon glyphicon-plus"></span> &nbsp;  Add New  </a> 
...
<table width="100%" class="table table-bordered table-responsive table-hover" group_id="dataTables-example">
				...
				<td><a  class="btn btn-info" href="payment-status-edit?edit_id=<?php echo $eqrow['ps_id']; ?>" title="click for edit" 
