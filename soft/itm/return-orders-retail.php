...
<body>
<center><h4><ol class="breadcrumb"> <li class="active">Invoices - Retail </li></ol></h4></center>
...
<div class="panel panel-primary">
	<div class="panel-heading"> 
		<?php if($_GET['o'] == 'add') { ?>
       <i class="glyphicon glyphicon-plus-sign"></i>  New Invoice  &nbsp;&nbsp;    <a style="color:white;" href="orders-retail?o=manord"><i class="glyphicon glyphicon-file"></i>  View Invoice </a> 
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Manage Invoice &nbsp;&nbsp; <a style="color:white;" href="orders-retail?o=add"><i class="glyphicon glyphicon-plus-sign"></i> New Invoice </a> 
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Edit Invoice &nbsp;&nbsp; <a style="color:white;" href="orders-retail?o=manord"><i class="glyphicon glyphicon-file"></i>  View Invoice </a> 
		<?php } ?>
	</div>  
			  ...
			  <table class="table" id="productTable" >
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:14%;"><center> Short Details  </center></th>  
			  			<th style="width:7%;"><center> Price </center></th>		
		<!--  			<th style="width:6%;"><center> Stock.Qty  </center></th> --> 
			  			<th style="width:6%;"><center> Quantity  </center></th> 
				 ...
				 <?php
			  		...
			  		for($x = 1; $x < 2; $x++) { ?> <!-- productTable Row View Amount 1 < 2 = 1 -->
			  			...
			  			?>
							...
							<td style="padding-left:28px;">
			  					<div class="form-group">
			  					<input type="text" name="Discount[]" id="Discount<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" class="form-control center"  />
			  					</div>
			  				</td>
...
<div class="col-md-4">  
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/ReturnOrderRs.php" id="editOrderForm">
			...
			orders.payment_type,payment_type.pt_name,orders.payment_status,payment_status.ps_name , orders.inv_courier,courier.courier_name,orders.courier_charge ,orders.dis_taka,orders.dis_prcnt 
			FROM orders  
...
<div class="col-md-12">	
			  <table class="table" id="productTable">
			  	<thead>
			            <th style="width:18%;"> Product / Service </th> 
			  			<th style="width:14%;"><center> Short Details  </center></th>  
			  			<th style="width:6%;"><center> Price </center></th>		
		<!--  			<th style="width:6%;"><center> Stock.Qty  </center></th> --> 
		...
		<!--  			<th style="width:6%;"><center> S.Total  </center></th>	-->  			
			  			<th style="width:10%;"><center> Dis% </center></th>			  			
			  			<th style="width:7%;"><center> Total </center></th>			  			
			  			<th style="width:5%;"><center>Remove</center></th>
			  	</thead>
			  	<tbody>
					...
					order_item.rate,order_item.single_sub_total,order_item.buy_rate, order_item.total, order_item.short_details, order_item.single_dis_taka, order_item.single_dis_prcnt, order_item.single_discount,order_item.back_qty 
					FROM order_item 
					...
					WHERE order_item.order_id = {$orderId}";
			  		...
			  		while($orderItemData = $orderItemResult->fetch_array()) { 
			  			...
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
							...
							<td style="padding-left:15px;">
			  					<div class="form-group">
			  					<input type="text" name="quantity1[]" id="quantity1<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control center" min="1" value="<?php echo $orderItemData['order_quantity']; ?>" disabled="true"/>
			  					<input type="hidden" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control center" min="1" value="<?php echo $orderItemData['order_quantity']; ?>" />
			  					</div>
			  				</td>
							...
							<td style="padding-left:30px;">
			  				...
			  				<td> 
			  	<center><button class="btn btn-default removeProductRowBtn center" type="button" id="removeProductRowBtn" onclick="removeProductRow(<?php echo $x; ?>)"><i class="glyphicon glyphicon-trash"></i></button></center>
			  				</td>
			  			</tr>
		  			<?php
		  			$arrayNumber++;
