...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO account_bank_balance (user_id,pre_balance,today_in,today_out,current_balance,payment_type,received_by,last_update,status) 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>New Bank Balance | <span> <a href="balance"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
