...
<center><h3><ol class="breadcrumb"> <li class="active"> Product Received </li></ol></h3></center>
...
<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-success"  style="width:100%" href="product_received_report.php"> <span class="glyphicon glyphicon-file"></span> Report </a> 
		</div>
...
<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
	...
	<?php
			$eq=mysqli_query($con,"SELECT product_transfer.admin_id,product_transfer.user_id, product_transfer.product_id, product_transfer.product_name, 
		...
		left JOIN stuff ON stuff.userid = product_transfer.admin_id 
		
		WHERE product_transfer.user_id ='".$_SESSION['id']."' order by product_transfer.id desc Limit 100");
