...
<?php 
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM prjct_income 
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE prjct_income 
...
<center><h4><ol class="breadcrumb"> <li class="active">Project Income Edit </li></ol></h4></center>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
	  ...
	  <tr>
		...
		<option value="<?php echo $inc_cat; ?>"><?php echo $name; ?></option>
	...
	<tr>
        ...
        <a class="btn btn-danger" href="Project-Income"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
