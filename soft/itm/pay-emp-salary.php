...
$stmt = $DB_con->prepare('INSERT INTO employees_salary_details (user_id,emp_id,year,month, salary,bonus,total_salary,adv_paid,full_paid,recent_due,entry_date,sal_type,comment) 
			                                     VALUES(:UserId,:EmpId,:Year,:Month,:Salary,:Bonus,:TotalSal,:Adv,:Full,:RecentDues,:Date,5,"Full Paid" )');
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='pay-emp-salary';
				</script>
                <?php
			}
			else{
...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Pay Employee Salary |  <span> <a href="emp-salary-list">    <i class="bi bi-table"></i> </a> </span> </h1>
	  <hr>
    </div> 
...
<form method="post" enctype="multipart/form-data" class="form-horizontal" >
	...
	<tr>
		...
		<option value="#">Select Employee Name</option>
                        ...
                        where employees_salary.user_id='".$_SESSION['id']."' and  employees_salary.status=1
						";
 ...
 <tr>
    ...
    <tr>
        ...
        <td>
		<input style="width:99%;" class="form-control text-center" type="text" id="PreAdv" name="PreAdv" placeholder="Pre Advance " value="0" oninput="myFunction()" disabled="true">
		</td>
    </tr>	
   
	<tr style="display:none;" >
    	<td><label class="control-label"> Advance  </label></td>
        <td><input class="form-control" type="text" id="Adv" name="Adv" placeholder="Advance  " value="0" oninput="myFunction()"></td>
    </tr>
	
	<tr style="display:none;" >
    	<td><label class="control-label"> Total Advance  </label></td>
        <td>
		<input  class="form-control" type="text" id="TotalAdv1" name="TotalAdv1" placeholder="Total Advance  " value="0" oninput="myFunction()" disabled="true" >
...
<!-- Recent Dues -->		
	...
	<tr>
    	<td><label class="control-label">Payable Salary | Current Dues</label></td>
        <td>
		<input style="width:49%;float:left;" class="form-control text-center" type="text" id="Full" name="Full" placeholder="Total Salary" value="0" oninput="myFunction()" readonly>
        <input style="width:49%;float:left;margin-left:5px;" class="form-control text-center" type="text" id="RecentDues1" name="RecentDues1" placeholder="Current Dues" value="<?php echo $RecentDues; ?>" disabled="true" />
	...
	<tr >
    	<td><label class="control-label">Salary Status</label></td>
       	<td><select style="width:99%;" class="form-select" name="Status"  value="<?php echo $status; ?>" />
		<option value="0">Total Paid</option> 
		</select> </td>       
	</tr>
        ...
        <td>
		<input style="width:99%;" class="form-control" type="Date" name="Date" placeholder="" value="<?php echo date('Y-m-d'); ?>" />
		 </td>
    </tr>
