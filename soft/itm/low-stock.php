...
<?php
	...
	{ 
		$stmt_delete = $DB_con->prepare('DELETE FROM stock_low WHERE id=:uid');
...
<center><h4><ol class="breadcrumb"> <li class="active">Low Stock </li></ol></h4></center>	

<div class="container"> 	  
	   
    	<div class="div-action pull pull-left" style="padding-bottom:8px;">
		<a class="btn btn-primary" href="low-stock-add"> <span class="glyphicon glyphicon-plus"></span> &nbsp;  Add New  </a> 
...
<table width="100%" class="table table-bordered table-responsive table-hover" group_id="dataTables-example">
                        ...
                        <tbody id="tbody">
							<?php
							  $sl=0;
								$eq=mysqli_query($con,"select * from stock_low
								...
								while($eqrow=mysqli_fetch_array($eq)){ 
									?>
										<tr> 
											<td><?php echo ++$sl; ?></td>
											<td><?php echo $eqrow['low_qty']; ?></td>
											 
											
				<td><a  class="btn btn-info" href="low-stock-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" 
