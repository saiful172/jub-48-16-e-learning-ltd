...
<center><h4><ol class="breadcrumb"> <li class="active">Lead Update</li></ol></h4></center>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
	 ...
	 <tr>
        ...
        <a class="btn btn-danger" href="leads"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
        </td>
     </tr>
