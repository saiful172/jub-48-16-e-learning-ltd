...
<?php
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO prjct_expense (user_id,prj_name,exp_cat,prj_details,qty,kg,litre,other,cost_price,pym_type,reference,entry_date,status)
			                                              VALUES(:UserId,:PrjName,:ExpCat,:PrjDetails,:Qty,:KG,:Litre,:Other,:CostPrice,:PymTyp,:Refer,:Date,1)');
...
<center><h4><ol class="breadcrumb"> <li class="active">Project Expense Add  </li></ol></h4></center>	
