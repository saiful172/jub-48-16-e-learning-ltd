              ...
              <div class="tab-content pt-2">
                ...
                <form role="form" method="POST" action="logo.php" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9"> 
                       <img src="../<?php if ($srow['photo']==""){echo "img/profile.jpg"; } else {echo $srow['photo'];} ?>" width="150px" class="rounded-circle">
          ...
          <div class="card">
            ...
            <?php
					    ...
					    <?php echo $dqrow['business_details']; ?>
						 ...
						 <img src="../<?php if($dqrow['sign_img']==""){echo "/img/samiul.png";}else{echo $dqrow['sign_img'];} ?>" width="70%" class="rounded-circle">
