...
<center><h4><ol class="breadcrumb"> <li class="active">Employee's Salary </li></ol></h4></center>
...
<div class="buttons">
		...
		<div class="col-md-12">
		<a class="btn btn-primary btn-w100"  href="employee-salary-create"> <span class="glyphicon glyphicon-hdd"></span> <span class="glyphicon glyphicon-unchecked"></span> Create Salary </a> 
		</div>
		
        <div class="col-md-12">
		<a class="btn btn-primary btn-w100"  href="employee-salary-paid"> <span class="glyphicon glyphicon-hdd"></span> <span class="glyphicon glyphicon-new-window"></span> Pay Salary </a> 
		</div>
	...
	<?php
	$eq=mysqli_query($con,"select * from employees_salary  
	Left JOIN employees ON employees.id = employees_salary.emp_id
	where employees_salary.user_id='".$_SESSION['id']."' ORDER BY employees_salary.id DESC  ");
