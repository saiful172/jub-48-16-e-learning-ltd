...
<body>
<center><h3><ol class="breadcrumb"> <li class="active">Damage Product </li></ol></h3></center>
...
<div class="panel panel-primary">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
    <i class="glyphicon glyphicon-plus-sign"></i>  New Invoice  &nbsp;&nbsp;    <a style="color:white;" href="order-supplier?o=manord"><i class="glyphicon glyphicon-file"></i>  View Invoice </a> 
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Manage Invoice &nbsp;&nbsp; <a style="color:white;" href="order-supplier?o=add"><i class="glyphicon glyphicon-plus-sign"></i> New Invoice </a> 
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Edit Invoice &nbsp;&nbsp; <a style="color:white;" href="order-supplier?o=manord"><i class="glyphicon glyphicon-file"></i>  View Invoice </a> 
		<?php } ?>
	</div> <!--/panel-->	
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="supplier_info/createOrderDamage.php" id="createOrderForm">
...
<div class="col-md-4">	
		...
		<?php }?>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="SupplierInv" name="SupplierInv" Value="0"  autocomplete="off" />
			    </div>
			  </div>
...
<div class="col-md-4">	
			  ...
			  <table class="table" id="productTable" >
			  	<thead>
			  		<tr>			  			
			  			...
			  			<th style="width:15%;"><center> Short Details  </center></th> 
						 
			  			<th style="width:8%;"><center> Price </center></th>		
						
			  			<th style="width:6%;"><center> Stock  </center></th> 
			  			<th style="width:6%; display:none;"><center> Qty  </center></th>
						
						<th style="width:6%;"><center> Dam.Qty  </center></th> 
			  			<th style="width:6%; display:none;"><center> Back.Qty  </center></th> 
				 ...
				 <?php
			  		...
			  		for($x = 1; $x < 2; $x++) { ?> <!-- productTable Row View Amount 1 < 2 = 1 -->
			  			...
			  			?>
							...
							<td style="padding-left:0px;display:none;">
			  					<div class="form-group">
			  					 <input type="text" name="BackQty[]" id="BackQty<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control center" />
			  					</div>
			  				</td>
 ...
 <div class="col-md-4" style="display:none;">
			  	...
			  	<div class="form-group">
				    ...
				    <div class="col-sm-6">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" value="0" onkeyup="paidAmount()"  />
...
<div class="col-md-12">	
			  <table class="table" id="productTable">
			  	...
			  	<tbody>
					...
					sup_order_item.rate, sup_order_item.total, sup_order_item.short_details,sup_order_item.single_discount,sup_order_item.back_qty
					FROM sup_order_item 
...
<div class="form-group">
				    <label for="clientContact" class="col-sm-5 control-label">Select Comment</label>
				    <div class="col-sm-7">
				      <select class="form-control chosen-select" name="InvComments" id="InvComments">
				      	<option >Select</option>
						<?php 
				...
				<div class="form-group">
				    <label for="grandTotal" class="col-sm-5 control-label">Comments</label>
				    <div class="col-sm-7">
...
<script src="custom/js/order_supplier_dam.js"></script>
