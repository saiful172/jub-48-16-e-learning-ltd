              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-hover table-responsive">
                  ...
                  <tr class="d-none">
                    ...
                    <td><input class="form-control" type="number" name="CrntBalCashBank" id="CrntBalCashBank" value="0" readonly></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="number" name="CrntBalCashBankTo" id="CrntBalCashBankTo" value="0" readonly></td>
                  </tr>
                  ...
                  <script>
                    function myFunctionAmt() {
                      ...
                      document.getElementById("CrntBalCashBankTo").value = z;
      ...
      if (BankIdTo == "") {
        ...
        $.ajax({
          ...
          success: function(result) {
            ...
            $("#CrntBalCashBankTo").val(customer.RecentAmt);
          }
        });
      }
    });
