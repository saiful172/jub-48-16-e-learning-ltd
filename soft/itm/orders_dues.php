	...
	<div class="panel-body">
        ...
        <div class="form-group">
			  	...
			  	<tbody>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?> <!-- productTable Row View Amount 1 < 2 = 1 -->
			  			<tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">			  				
			  				...
			  				<td style="padding-left:20px;">
			  					<div class="form-group">
			  					<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" class="form-control"  />
			  					</div>
			  				</td>
			  				<td style="padding-left:20px;">			  					
			  ...
			  <div class="col-md-6">
			    ...
			    <div class="form-group">
				    <label for="GTotal" class="col-sm-3 control-label">Grand Total</label>
				    <div class="col-sm-9">
		...
		<!--	Recent Dues / Due	 -->  
				   <div class="form-group">
				    <label for="RecDues" class="col-sm-3 control-label">Recent Dues</label>
				    <div class="col-sm-9">
...
<!-- Recent Kisti -->
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Order Date eryreyrey </label>
			    <div class="col-sm-10">
