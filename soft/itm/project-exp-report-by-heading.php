...
<center><h4><ol class="breadcrumb"><li>Project Expense Report</li> </ol> </h4></center>
	...
	<div class="col-md-7">
		<div class="panel panel-info">
			<div class="panel-heading">
				...
				<i class="glyphicon glyphicon-check"></i> Expense Report By Project  
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				
				<form class="form-horizontal" action="php_action/project-exp-report-by-heading" method="post" id="getOrderReportForm">
		...
		<option value="#">Select project</option>
				      	<?php 
				      	$sql = "SELECT distinct prjct_expense.prj_name,prjct_name.pj_name FROM prjct_expense 
						left join prjct_name on prjct_name.pj_id=prjct_expense.prj_name
						where prjct_expense.user_id='".$_SESSION['id']."'
						";
