...
<?php
	...
	{ 
		$stmt_delete = $DB_con->prepare('DELETE FROM project_incom_cat WHERE of_id=:uid');
...
<center><h4><ol class="breadcrumb"> <li class="active">Project Income Category </li></ol></h4></center>	

<?php require_once 'more-fals/project-link-btn.php'; ?> 

<div class="col-md-2">
<a class="btn btn-warning text-black" href="Project-Income-Cat-Add" > <span class="glyphicon glyphicon-plus"></span> Add New Project  </a> 
</div> 
...
<table width="100%" class="table table-bordered table-responsive table-hover" group_id="dataTables-example">
                        ...
                        <tbody id="tbody">
							<?php
							  $sl=0;
								$eq=mysqli_query($con,"select * from project_incom_cat
				...
				<td><a  class="btn btn-info" href="Project-Income-Cat-Edit?edit_id=<?php echo $eqrow['of_id']; ?>" title="click for edit" 
