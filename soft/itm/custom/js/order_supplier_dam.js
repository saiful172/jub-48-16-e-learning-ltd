	   	...
	   	for (var x = 0; x < quantity.length; x++) {       						
			...
			if(orderDate && clientName && clientContact && PreDue && paid && discount && paymentType && paymentStatus) {
				if(validateProduct == true && validateQuantity == true) {
	            	...
	            	'<a href="order-supplier?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Order </a>'+
	...
	$.ajax({
		...
		success:function(response) {
			...
			var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+			  				
				...
				'<td style="padding-left:17px;">'+
					'<div class="form-group">'+
					'<input type="text" name="StockQty1[]" id="StockQty1'+count+'" onkeyup="getTotal('+count+')"  autocomplete="off" class="form-control center " disabled="true" />'+
					'<input type="hidden" name="StockQty[]" id="StockQty'+count+'" onkeyup="getTotal('+count+')"  autocomplete="off" class="form-control center "  />'+
					'</div>'+
				'</td>'+
				...
				'<td style="padding-left:28px; display:none;">'+
					'<div class="form-group">'+
				...
				'<td style="padding-left:30px;">'+
					'<div class="form-group">'+
					'<input type="text" name="RecentStock1[]" id="RecentStock1'+count+'" onkeyup="getTotal('+count+')" autocomplete="off" class="form-control center " disabled="true" />'+
					'<input type="hidden" name="RecentStock[]" id="RecentStock'+count+'" onkeyup="getTotal('+count+')" autocomplete="off" class="form-control center "  />'+
					'</div>'+
				'</td>'+
		...
		if(productId == "") {
			...
			$.ajax({
				...
				success:function(response) {
					...
					$("#RecentStock1"+row).val(RecentStock);
