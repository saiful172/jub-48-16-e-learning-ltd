  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (empty($PreBalance)) {
      ...
      if ($stmt->execute()) {
        ...
        $stmt_details = $DB_con->prepare('INSERT INTO account_balance_details (user_id, pre_balance, today_in, today_out, current_balance, payment_type, received_by, last_update, status) VALUES (:UserId, :PreBalance, :TodayIn, :TodayOut, :CurBalance, :PayType, :ReceivedBy, :LastUpdate, 1)');
