...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main"> 
    ...
    <div class="pagetitle">
     <h1>Customer Recent Dues | <span> <a href="customer-only-dues">  <i class="bi bi-list"></i> </a> </span> |  <span> <a href="customer-dues-paid">   <i class="bi bi-check2-circle"></i> </a> </span> </h1>
       <hr>
    </div> 
