...
<tr>
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
       <input class="form-control" type="text" id="Details"  name="Details"   value="Na"  /></td>
    </tr>
	...
	<tr>
        ...
        <td> <input class="form-control" type="text" id="ReatilSaleRate"  name="ReatilSaleRate" placeholder="Sale Rate - MRP" value=""  oninput="myFunction()" /></td>
    </tr>
	...
	<tr>
        ...
        <td><input class="form-control" type="text" id="BuyRate" name="BuyRate" placeholder="Buy Rate" ></td>
    </tr>
  ...
  function myFunction() {
	...
	<tr style="display:none;">
        ...
        <td><input class="form-control" type="text" id="WholSaleRate"  name="WholSaleRate" value="0"   oninput="myFunctionTP()" /></td>
    </tr>
