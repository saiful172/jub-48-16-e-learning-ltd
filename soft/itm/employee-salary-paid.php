	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			...
			if($stmt->execute()){
				...
				window.location.href='employee-salary-paid';
				</script>
                <?php
			}
			else{
...
<center><h4><ol class="breadcrumb"> <li class="active"> Pay Salary </li></ol></h4></center>
<div class="col-md-2">
<div class="buttons">
...
<!-- Recent Dues -->		
	...
	<tr >
    	<td><label class="control-label">Salary Status</label></td>
       	<td><select style="width:99%;" class="form-control" name="Status"  value="<?php echo $status; ?>" />
