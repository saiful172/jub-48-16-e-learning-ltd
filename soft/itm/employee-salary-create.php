...
$stmt = $DB_con->prepare('INSERT INTO employees_salary (user_id,emp_id,year,month, salary,bonus,total_salary,adv_paid,full_paid,recent_due,entry_date,last_update,status) 
			...
			if($stmt->execute())
			{
				...
				window.location.href='employee-salary-create';
				</script>
                <?php
			}
			else
...
<body>
<center><h4><ol class="breadcrumb"> <li class="active">  Create Salary   </li></ol></h4></center>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
		...
		<select style="width:49%;float:left;" class="form-control"  name="Year" required> 
		<option value="2023">2023</option>
	    </select>
		
		<select style="width:49%;float:left;margin-left:5px;" class="form-control"  name="Month" required>
