...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder_paid.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      ...
				      <input type="hidden" class="form-control" id="dueValue" name="dueValue" oninput="myFunction()" />
				    </div>
				  </div> 
