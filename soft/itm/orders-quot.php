...
<main id="main" class="main">
 <div class="pagetitle">
      <h1>	  
		<?php if($_GET['o'] == 'add') { ?>
       <i class="glyphicon glyphicon-plus-sign"></i>  New Quotation  &nbsp; | &nbsp;    <a  href="orders-quot?o=manord"> <i class="bi bi-table"></i> </a> 
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Manage Quotation &nbsp; | &nbsp; <a  href="orders-quot?o=add">  <i class="bi bi-plus-square-fill"></i> </a> 
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Edit Quotation &nbsp; | &nbsp; <a  href="orders-quot?o=manord"> <i class="bi bi-table"></i> </a> 
		<?php } ?>
...
<div class="col-lg-4">	
				...
				<?php 
				   $pq=mysqli_query($con,"select MAX(id)+1 as max_id,user_id from quot_orders where user_id='".$_SESSION['id']."' ");
				   while($pqrow=mysqli_fetch_array($pq)){
				?>
        <td>
			  		...
			  		for($x = 1; $x < 2; $x++) { ?> <!-- productTable Row View Amount 1 < 2 = 1 -->
			  			...
			  			?>
							...
							<td style="padding-left:20px;">
			  				...
			  				<td>
                          <center> <button class="btn btn-danger removeProductRowBtn" type="button" id="removeProductRowBtn" onclick="removeProductRow(<?php echo $x; ?>)"><i class="bi bi-trash-fill"></i></button> </center>
			  				</td>
			  			</tr>
		  			<?php
		  			$arrayNumber++;
...
<button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"> <i class="bi bi-check-circle"></i> Quotation Update </button>
			    </div>
			  </div>
