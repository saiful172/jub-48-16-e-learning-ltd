...
<div class="buttons"> 
	...
	<div class="col-md-12">
	   ...
	   <div class="col-md-12">
	    ...
	    <div class="col-md-12">
			<a class="btn btn-danger btn-w100" href="low-stock-edit"> <span class="glyphicon glyphicon-cog"></span> &nbsp;  Low Stock Setting - <?php echo $LowQty; ?> </a> 
	   </div>
...
<table width="100%" class="table table-bordered table-hover" group_id="dataTables-example">
                        ...
                        <tbody id="tbody">
							<?php
								...
								WHERE  quantity < $LowQty and  user_id='".$_SESSION['id']."' ORDER BY product_id asc ");
