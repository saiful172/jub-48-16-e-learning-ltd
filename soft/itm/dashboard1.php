	...
	<div class="col-md-3">
		<div class="panel panel-danger">
			<div class="panel-heading">
				<a href="productN.php" >
			  <i class="glyphicon glyphicon-list"></i>  Product / Service 
...
<div class="col-md-3">
		<div class="panel panel-success">
			<div class="panel-heading">
				...
				<a  href="customer.php" >
					 <i class="glyphicon glyphicon-user"></i> Customer
					<span class="badge pull pull-right">
<?php 
    ...
    ?></h3></p>
		...
		<div class="card">
		  <div class="cardHeader" style="background-color:#245580;">
		    <img src="../includes/itm.png"  width="28%" />
		  </div>
