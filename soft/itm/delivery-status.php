...
<?php
	...
	{ 
		$stmt_delete = $DB_con->prepare('DELETE FROM delivery WHERE id=:uid');
...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle"> 
	  <h1>Delivery Status | <span> <a href="delivery-status-add">  <i class="bi bi-plus-square-fill"></i> </a> </span>  </h1>
	  <hr>
    </div> 
            ...
            <div class="card-body">
              ...
              <table width="100%" class="table table-hover datatable">
                ...
                <tbody id="tbody">
							<?php
							  $sl=0;
								$eq=mysqli_query($con,"select * from delivery
								...
								while($eqrow=mysqli_fetch_array($eq)){ 
									?>
										<tr> 
											<td><?php echo ++$sl; ?></td>
											<td><?php echo $eqrow['dlvry_name']; ?></td> 
											 
											
				<td><a  class="btn btn-info" href="delivery-status-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" 
