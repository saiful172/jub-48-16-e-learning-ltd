...
<div class="pagetitle">
      <h1>	  
		<?php if($_GET['o'] == 'add') { ?>
       <i class="glyphicon glyphicon-plus-sign"></i>  New Invoice  &nbsp; <span> <a href="orders-retail-full?o=add">   <i class="bi bi-fullscreen"></i> </a>  &nbsp;   <span> <a href="orders-retail?o=manord">   <i class="bi bi-table"></i> </a></span>  
