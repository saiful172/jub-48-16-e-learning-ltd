...
<div class="col-md-4">	
		...
		<?php }?>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="SupplierInv" name="SupplierInv" autocomplete="off" />
			    </div>
			  </div>
...
<div class="col-md-4">  
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="supplier_info/editOrderReturn.php" id="editOrderForm">
