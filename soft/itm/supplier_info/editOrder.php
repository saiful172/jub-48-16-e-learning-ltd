...
if($_POST) {	
  ...
  $Comments 					= $_POST['Comments'];
	...
	if($readyToUpdateOrderItem) {
		...
		for($x = 0; $x < count($_POST['productName']); $x++) {			
			...
			while ($updateProductQuantityResult = $updateProductQuantityData->fetch_row()) {
				...
				VALUES ('$orderId','$orderId','".$_POST['productName'][$x]."', '".$_POST['quantity'][$x]."','".$_POST['AddQty'][$x]."','0','0','0','".$_POST['BackQty'][$x]."', '".$_POST['RecentStock'][$x]."', '".$_POST['rate'][$x]."','".$_POST['BuyRate'][$x]."','".$_POST['SingTotal'][$x]."', '0','0', '".$_POST['DiscountSin'][$x]."','".$_POST['totalValue'][$x]."', '".$_POST['ShortDetails'][$x]."',2,NOW(),$UserId ,'Add/Edit.Sup')";
	...
	$valid['success'] = true;
	$valid['messages'] = "Update Successful...";		
