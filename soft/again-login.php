        ...
        <div class="container">
            ...
            <div class="workinghny-form-grid">
                <div class="main-mockup">
					...
					<span style="color:blue; font-size:18px;"><img src="img/logout.png" width="110px" /> </span>
                        <h2> Digital Invoice Manager </h2>  <br><br>
                          
                        <h3 class="alert alert-danger pt-4" style="width:100%;"> You forgot to logout! Please 
