...
<br>
<center><h4> <?php include('name.php'); ?> <br> Supplier List ( In-Active )<br>
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <table width="100%" class="table table-bordered" style="font-size:13px;">
						...
						<tbody>
							<?php
								$eq=mysqli_query($con,"select * from supplier where  supplier.status=0 order by supplier_id DESC");
