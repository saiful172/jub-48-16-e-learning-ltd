...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<i class="glyphicon glyphicon-check"></i> Supplier Dues Report - Single
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="form-group">
				    <label for="startDate" class="col-sm-2 control-label">Supplier Id</label>
				    <div class="col-sm-10">
				      <td> <input  type="text" class="form-control" id="SupId" name="SupId" placeholder="Supplier Id" autocomplete="off" />  </td>
				    </div>
				  </div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<i class="glyphicon glyphicon-check"></i> Supplier Dues Report - Date Wise
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
