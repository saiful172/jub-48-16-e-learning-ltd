...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<i class="glyphicon glyphicon-check"></i>	Daily Sales Report - By User
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				
				<form class="form-horizontal" action="php_action/DailySalesReportUser.php" method="post"  id="getOrderReportForm">
