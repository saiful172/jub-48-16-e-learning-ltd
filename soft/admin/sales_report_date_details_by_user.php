	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<i class="glyphicon glyphicon-check"></i>	Sales  Report  Date Wise ( Details )
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				
				<form class="form-horizontal" action="php_action/sales_report_date_details_by_user.php" method="post" id="getOrderReportForm">
