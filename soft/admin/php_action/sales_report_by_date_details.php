...
if($_POST) {
	...
	WHERE order_date >= '$start_date' AND order_date <= '$end_date' and order_status = 1   order by order_id desc";
...
if($_POST) {
	...
	WHERE order_date >= '$start_date' AND order_date <= '$end_date' and order_status = 1  group by order_id desc";
	$query = $connect->query($sql);
	$countOrder = $query->num_rows;
...
if($_POST) {
	...
	<table border="1" class="table table-bordered" style="width:100%;">
		...
		<tr>
			...
			<td><center><b>  Total Price  = '.$totalAmount1.'</center></td>
...
if($_POST) {
	...
	<table border="1" class="table table-bordered" style="width:100%;">
		...
		<tr>
			<td><center><b> Discount = '.$Discount.'</center></td>
		</tr>
	</table>
	';	
	echo $table;
...
if($_POST) {
	...
	<table border="1" class="table table-bordered" style="width:100%;">
		...
		<tr>
			<td><center><b>  Grand Total Price    = '.$TodayTotal.'</center></td>
		</tr>
	</table>
	';	
	echo $table;
