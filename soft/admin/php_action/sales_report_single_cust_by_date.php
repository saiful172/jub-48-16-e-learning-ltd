...
if($_POST) {
	...
	WHERE orders_details.customer_id= '$CustId' and order_date >= '$start_date' AND order_date <= '$end_date'  order by order_id desc";
	$query = $con->query($sql);
	...
	<table border="1" class="table table-bordered" style="width:100%;">
		...
		<tr>
			<td colspan="7" "><center> <b>Total Invoice = '.$countOrder.' </b></center></td>
		</tr>
