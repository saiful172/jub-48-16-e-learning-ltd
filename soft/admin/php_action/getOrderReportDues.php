...
<body>
 ...
 <br>
<center><h4> <?php include('../name.php'); ?><br>Date Wise Collection Report  <br>
<?php
...
if($_POST) {
	...
	<table width="100%" class="table table-bordered" style="font-size:14px;">
     ...
     <tr>
		 <th colspan="8" style="font-size:17px; color:Green; "> Collection Report </th>
	    <tr>
		...
		<tr>
			<td colspan="9">  <center><b>Total = '.$countOrder.' |  Total Collection = '.$totalPaid.' </b> </center></td>
		</tr>
