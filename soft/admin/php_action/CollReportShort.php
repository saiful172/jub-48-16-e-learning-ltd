...
if($_POST) {
	...
	$sql = "SELECT * FROM orders_details WHERE  order_date >= '$start_date' AND order_date <= '$end_date'   order by id desc ";
	$query = $con->query($sql);
	...
	<table width="100%" class="table table-bordered" style="font-size:14px;">
     ...
     <tr>
		 <th colspan="7" style="font-size:17px; color:Green; "> Collection Report Short</th>
	    <tr>
		...
		<tr>
			<td colspan="7">  <center><b>Total = '.$countOrder.' |  Total Collection = '.$totalPaid.' </b> </center></td>
		</tr>
