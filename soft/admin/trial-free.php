...
<?php
	...
	{ 
		$stmt_delete = $DB_con->prepare('DELETE FROM free_trial WHERE id=:uid');
...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle"> 
	  <h1>Free Trial | <span> <a href="#">  <i class="bi bi-plus-square-fill"></i> </a> </span>  </h1>
	  <hr>
    </div> 
          ...
          <div class="card">
            <div class="card-body">
              ...
              <tbody id="tbody">
							<?php
							  $sl=0;
								$eq=mysqli_query($con,"select * from free_trial 
								ORDER BY id DESC ");
