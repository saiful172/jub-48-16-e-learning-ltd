		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" data-target="#addBrandModel"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Brand    </button>
				</div> <!-- /div-action -->				
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeMemberModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <center><h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Cancel Brand  </h4> <center>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <center><p>Do You Cancel The Brand ?</p><center>
      </div>
