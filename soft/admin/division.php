...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle"> 
	  <h1>Division | <span> <a href="division-add">  <i class="bi bi-plus-square-fill"></i> </a> </span>  </h1>
	  <hr>
    </div> 
            ...
            <div class="card-body">
              ...
              <table width="100%" class="table table-hover datatable">
               <thead>
				...
				<td><a  class="btn btn-info" href="division-edit?edit_id=<?php echo $eqrow['div_id']; ?>" title="click for edit" 
