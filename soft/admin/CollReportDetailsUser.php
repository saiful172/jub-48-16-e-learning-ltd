...
<center><h4><ol class="breadcrumb"><li >Date Wise Collection Report Details - By User </li> </ol> </h4></center>
<div class="container">
...
<div class="row">
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<i class="glyphicon glyphicon-check"></i>	Collection Report Details - By User
			</div>
			<!-- /panel-heading -->
			<div class="panel-body">
				
				<form class="form-horizontal" action="php_action/CollReportDetailsUser.php" method="post"  id="getOrderReportForm">
