...
<center><h4><ol class="breadcrumb"> <li class="active">All Supplier  </li></ol></h4></center>
...
<div style="width:100%" class="form-group input-group">
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-success" style="width:100%" href="supplier_all_view.php"> <span class="glyphicon glyphicon-file"></span> Report ( All ) </a> 
		</div>
