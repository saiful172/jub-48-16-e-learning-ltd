...
<div class="row">
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Product List</div>
			</div> <!-- /panel-heading -->
	...
	<!-- <button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Add New Product </button> -->
				...
				<a  href="php_action/view_product_details.php" class="btn btn-primary"> <i class="fa fa-file"></i>  Stock Details</a>
				<a  href="php_action/print_product.php" class="btn btn-primary"> <i class="fa fa-file"></i>  Print </a>
...
<div class="modal fade" id="addProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Product Photo : </label>
	 ...
	 <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productId" placeholder="Product Id " name="productId" autocomplete="off">
				    </div>
	        </div> 
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Sale Price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rate" placeholder="Sale Price" name="rate" autocomplete="off" oninput="myFunctionTP()">
				    </div>
	        </div> 
			
			<div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Total Sale Price: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="totalrate" placeholder="Total Sale Price" name="totalrate" autocomplete="off" >
				    </div>
	        </div>
			<script>
  function myFunctionTP() {
    ...
    document.getElementById("totalincome").value = z2;
			...
			<div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Buy Price : </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="buyrate" placeholder="Buy Price " name="buyrate" autocomplete="off" oninput="myFunctionTP()">
				    </div>
	        </div>
			
			<div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label"> Total Buy Price : </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="totalbuyrate" placeholder="Total Buy Price " name="totalbuyrate" autocomplete="off" oninput="myFunctionTP()">
				    </div>
	        </div>
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="totalincome" placeholder="Total Income" name="totalincome" autocomplete="off" >
				    </div>
	        </div>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <ul class="nav nav-tabs" role="tablist">
				    ...
				    <li role="presentation"><a href="#productInfo" aria-controls="profile" role="tab" data-toggle="tab">Product Details</a></li>    
				  </ul>
				  ...
				  <div class="tab-content">
			        ...
			        <div class="form-group">
			        	<label for="editRate" class="col-sm-3 control-label">Sale Price : </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
					...
					<div class="form-group">
			        	<label for="editBuyRate" class="col-sm-3 control-label">Buy Price : </label>
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <center><h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Cancel Product</h4> <center>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <center><p>Do you Want Cancel The Product ?</p><center>
      </div>
