...
<center><h4><ol class="breadcrumb"> <li class="active"> Supplier In-Active </li></ol></h4></center>
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-success" style="width:100%" href="supplier_inactive_view.php"> <span class="glyphicon glyphicon-file"></span> Report ( In-Active ) </a> 
		</div>
...
<table width="100%" class="table table-striped table-bordered table-hover" supplier_id="dataTables-example">
                        ...
                        <tbody id="tbody">
							<?php
								$eq=mysqli_query($con,"select * from supplier  where  status=0 ORDER BY supplier_id DESC ");
