    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">Employee  List ( In-Active ) 
						<span class="pull-right">
							...
							<a  href="view_inactive_employee.php" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-print"></span> Print</a>
						</span>
						</h3>
                    </div>
                    <!-- /.col-lg-12 -->
                ...
                <div class="col-lg-12">
                   <table width="100%" class="table table-bordered " id="dataTables-example">
                        ...
                        <tbody>
							<?php
								$eq=mysqli_query($con,"select * from employee where status='0' order by id desc");
