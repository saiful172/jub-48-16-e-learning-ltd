...
<center><h4><ol class="breadcrumb"> <li class="active">Customer </li></ol></h4></center>
 <div style="width:100%" class="form-group input-group">
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-success" style="width:100%" href="customer_active_view.php"> <span class="glyphicon glyphicon-file"></span> Report ( Active ) </a> 
		</div>
...
<table width="100%" class="table table-striped table-bordered table-hover" customer_id="dataTables-example">
                       ...
                       <tbody id="tbody">
							<?php
								$eq=mysqli_query($con,"select * from customer  where  status=1 ORDER BY customer_id DESC  ");
				...
				<td><a  class="btn btn-info" href="customer_edit.php?edit_id=<?php echo $eqrow['customer_id']; ?>" title="click for edit" onclick="return confirm('Are you Sure To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
				<td><a class="btn btn-danger" href="?delete_id=<?php echo $eqrow['customer_id']; ?>" title="click for delete" onclick="return confirm('Are you Sure To Delete ?')"><span class="glyphicon glyphicon-remove-circle"></span> Delete</a> </td>
