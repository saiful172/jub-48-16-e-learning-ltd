...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i>  Manage Removable Invoice
	...
	<div class="panel-body">
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder_dues.php" id="createOrderForm">

			  
			  <div class="form-group">
			    <label for="UserId" class="col-sm-2 control-label">Worker Id</label>
			    <div class="col-sm-10">
				<?php
				...
				?>
			      <input type="text" class="form-control" id="UserId11" name="UserId11" value="<?php echo $pqrow['userid']; ?>" autocomplete="off" disabled="true" />
		...
		<?php }?>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
				 ...
				 <button type="button" class="btn btn-primary" id="loadCustomer" > <i class="glyphicon glyphicon-ok-sign"></i> Ok</button>
			    </div>
			  </div>
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" class="form-control" id="clientName1" name="clientName1" placeholder="Customer Name" autocomplete="off" disabled="true" />
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" class="form-control" id="clientContact1" name="clientContact1" placeholder="Contact Number" autocomplete="off" disabled="true" />
        ...
        <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="hidden" class="form-control" id="PreDue1" name="PreDue1" placeholder="Previous Due" autocomplete="off" disabled="true" onkeyup="myFunction()" />
			      <input type="text" class="form-control" id="PreDue" name="PreDue" placeholder="Previous Due" autocomplete="off" onkeyup="myFunction()" />
			    </div>
			  </div>			  <!--/form-group-->		
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-6">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()"  oninput="myFunctionTotal()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
			  ...
			  <div class="col-md-6">
			    ...
			    <div class="form-group">
				    <label for="GTotal" class="col-sm-6 control-label">Grand Total + PreDue </label>
				    <div class="col-sm-6">
...
<!-- Recent Kisti -->
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Add New Product </button>
			      ...
			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Create Order</button>
		...
		<?php } else if($_GET['o'] == 'manord') { 
			...
			<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<a  href="orders.php?o=manord" class="btn btn-primary"><i class="glyphicon glyphicon-shopping-cart"></i>  Back To Invoice Page </a>
				</div> 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			...
			FROM orders  WHERE orders.order_id = {$orderId}";
             ...
             <div class="form-group">
			    <label for="orderIDa" class="col-sm-2 control-label">Order Id </label>
			    <div class="col-sm-10">
             ...
             <div class="form-group">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-5 control-label">Today Total</label>
				    <div class="col-sm-7">
			  ...
			  <div class="col-md-6">
			  	...
			  	<div class="form-group">
				    <label for="GTotal" class="col-sm-5 control-label">Grand Total</label>
				    <div class="col-sm-7">
			  	...
			  	<div class="form-group">
				    <label for="paid" class="col-sm-5 control-label">Paid ( Order Date )</label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="paid11" name="paid11" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $data[11] ?>" disabled="true"   />
				      <input type="hidden" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $data[11] ?>"   />
				    </div>
				  </div> 
		...
		<!--	Recent Dues / Due	 -->  
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-7">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">~~SELECT~~</option>
				      	<option value="1" <?php if($data[15] == 1) { echo "selected"; } ?> >Full Payment</option>
				      	<option value="2" <?php if($data[15] == 2) { echo "selected"; } ?> >Advance Payment</option>
				      	<option value="3" <?php if($data[15] == 3) { echo "selected"; } ?> >Half Payment</option>
						<option value="4" <?php if($data[15] == 4) { echo "selected"; } ?> >Some Payment</option>
						<option value="5" <?php if($data[15] == 5) { echo "selected"; } ?> >No Payment</option>
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Deliver Order</button>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeOrderModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <center><h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> Delete Invoice  </h4> <center>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <center><p> Du You Want To Cancel Invoice ? </p><center>
      </div>
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal"> <i class="glyphicon glyphicon-remove-sign"></i> Close </button>
        <button type="button" class="btn btn-danger" id="removeOrderBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> Delete </button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
	...
	$("#loadCustomer").on("click", function(){
		...
		if(customerID == "")
		{
			...
			$.ajax({url: "ajax_c_load.php?c=" + customerID, success: function(result){
				...
				$("#GroupNo1").val(customer.groupNo);
				$("#GroupNo").val(customer.groupNo);
				$("#GroupName1").val(customer.groupName);
				$("#GroupName").val(customer.groupName);
...
<script src="custom/js/orders_remove_show.js"></script>
