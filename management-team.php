...
<body>
    ...
    <div class="row"> 	  
		...
		<div class="col-lg-3 col-md-6 d-flex align-items-stretch" style="margin:auto;">
		  ...
		  <div class="col-lg-3 col-md-6 d-flex align-items-stretch" style="margin:auto;">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img"> 
                <img src="assets/img/team/teams.jpg" class="img-fluid team-round" alt="">
                <div class="social">
                 
                </div> 
              </div>
              <div class="member-info">
                <h4>Rony chowdhury</h4>
 ...
 -->
        ...
        <?php include('operation-councelor.php'); ?>

        <?php include('dyd-project.php'); ?>

        <?php // include('business-dev-dept.php'); 
        ?>
