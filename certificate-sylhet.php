  ...
  <?php include('breadcrumb.php'); ?>  
    <section id="contact" class="contact">
	  ...
	  <div class="col-lg-12 text-center mt-4"> 
           <br><br> <h3>Certificate Verification <br> ভোলানন্দ-উত্তরণ কারিগরি প্রশিক্ষণ কেন্দ্র সিলেট </h3> <hr>
      </div>
	...
	?>    
        ...
        <div class="row mt-5 justify-content-center" data-aos="fade-up">
          <div class="col-lg-12">
            ...
            <form method="post" action="certificate-open-sylhet.php"  enctype="multipart/form-data" >
