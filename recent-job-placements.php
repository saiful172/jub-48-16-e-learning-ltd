...
<head>
  ...
  <title>Recent Job Placements - E-Learning & Earning LTD</title>
...
<body>
  ...
  <main id="main">
    ...
    <section id="success-students" class="success-students mt-5">
      <div class="container mt-5">

        <div class="section-title" data-aos="fade-down">
          <h2> Recent Job Placements </h2>
        </div>
        
 <div class="row">

	<?php
            $sql = mysqli_query($con, "SELECT * FROM success_student_section order by id desc ");
