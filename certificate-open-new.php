...
<head> 
 ...
 <style type="text/css"> 
   ...
   .bg-img {	
	background: url(assets/img/bg-image/certificate-bg1.jpeg)no-repeat center 0px;
   ...
   <div class="container mt-5">   
    ...
    <p style="font-size:18px;font-weight:bold;text-align:center;">  <br> 
	 <!-- <img  class="rounded" src="../dist/user_images/<?php echo $userPic; ?>" height="150" width="150" > --> 
	  <img  class="" src="assets/img/bg-image/16-dist-cert.png"  width="100%" > 
     </p>
