...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>Batch No |  <span> <a href="add-batch">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
		...
		<tbody id="tbody">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="edit-batch?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Do you want to edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
