...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO gallery_image (user_id,title,userPic) 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Gallery Picture | <span> <a href="gallery-image"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
