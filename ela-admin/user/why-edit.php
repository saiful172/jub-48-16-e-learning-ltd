...
<body>
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE why_section  SET  title =:Title, sub_title =:SubTitle, why_icon =:StatsIcon, userPic=:upic WHERE id=:uid');
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="StatsIcon" value="<?php echo $why_icon; ?>" ></td>
                  </tr>
