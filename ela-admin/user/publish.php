          ...
          <div class="card">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="publish-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="bi bi-pencil-square"></span> Edit</a> </td>
