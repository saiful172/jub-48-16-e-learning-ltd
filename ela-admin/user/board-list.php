...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>Board |  <span> <a href="add-board">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
		...
		<tbody id="tbody">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="edit-board?edit_id=<?php echo $eqrow['brd_id']; ?>" title="click for edit" onclick="return confirm('Do you want to Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
