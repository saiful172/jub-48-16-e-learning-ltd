...
if($_POST) {	
  ...
  $paymentStatus 				= $_POST['paymentStatus'];
	...
	mysqli_query($con2,"INSERT INTO orders_details (order_id,user_id,customer_id,order_date, client_name, client_contact,address pre_due,today_total, grand_total, paid,invoice_date_paid, deliver_date_paid, recent_due,cuses) 
