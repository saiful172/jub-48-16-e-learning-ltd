...
<img src="../<?php if($pqrow['photo']==""){echo "../img/user.jpg";}else{echo $pqrow['photo'];} ?>"  width="120px;"><br>
 ...
 <div id="right"> 
<b><h2><?php echo $pqrow['business_name']; ?></h2></b>
<div style="font-size:25px;">Invoice</div>
 <div>Invoice No : <b>itm-<?php echo $pqrow['custom_invoice_no']; ?> </b> | 
...
<p style="padding:10px;">Thanks For Work With Us</p>
</div> 
