...
if($_POST) {
	...
	<table width="100%" class="table table-bordered" style="font-size:14px;">
     ...
     <tr>
		 <th colspan="12" style="font-size:17px; color:Green; "> Collection Report Details </th>
	    <tr>
		...
		<tr>
			<td colspan="12">  <center><b>Total = '.$countOrder.' |  Total Collection = '.$totalPaid.' </b> </center></td>
		</tr>
