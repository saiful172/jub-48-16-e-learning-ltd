...
<center><h4><ol class="breadcrumb"> <li class="active">পণ্যের  ক্রয়-বিক্রয় / লাভ</li></ol></h4></center>	
	  <div style="width:100%" class="form-group input-group">
                 <span style="width:120px;" class="input-group-addon">সার্চ -০১ :</span>
				 <input id="myInput" style="width:100%; type="text"  class="form-control" placeholder="সার্চ করুন.....">
			  </div>
			  
		      <div style="width:100%" class="form-group input-group">
                 <span style="width:120px;" class="input-group-addon">সার্চ -০২ :</span>
				 <input id="myInput1" style="width:100%; type="text"  class="form-control" placeholder="সার্চ করুন.....">
			  </div>
	
    	<h1 class="h2">
		<a class="btn btn-success" href="prft_report_by_date.php"> <span class="glyphicon glyphicon-print"></span>  তারিখ অনুযায়ী রিপোর্ট</button> </a></span>
		<a class="btn btn-success" href="prft_report_by_date_short.php"> <span class="glyphicon glyphicon-print"></span>  তারিখ অনুযায়ী রিপোর্ট ( ছোট ) </button> </a></span>
		</h1> 
