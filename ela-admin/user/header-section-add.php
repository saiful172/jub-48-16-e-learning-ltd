...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO header_section (user_id,title,subtitle,link_one,link_two,details,userPic) 
															VALUES(:user_id,:Title,:SubTitle,:LinkOne,:LinkTwo,:Details,:upic)');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Header Section | <span> <a href="header-section"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <table class="table table-responsive">
                  ...
                  <tr>
                    ...
                    <td><input class="form-control" type="text" name="SubTitle" placeholder="Sub Title Name" value="<?php echo $SubTitle; ?>" required></td>
                  </tr>


                  <tr>
                    <td><label class="control-label">Link One </label></td>
                    <td><input class="form-control" type="text" name="LinkOne" placeholder="Link One" value="<?php echo $link_one; ?>" required></td>
                  </tr>


                  <tr>
                    <td><label class="control-label">Link Two </label></td>
                    <td><input class="form-control" type="text" name="LinkTwo" placeholder="Link Two" value="<?php echo $link_two; ?>" required></td>
                  </tr>
