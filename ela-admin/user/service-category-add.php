...
<body>
  ...
  if (isset($_GET['edit_id'])) {
    $eq = mysqli_query($con, "SELECT * FROM service_category WHERE id='" . $_GET['edit_id'] . "' ");
  ...
  ?>
        ...
        $stmt = $DB_con->prepare('UPDATE service_category  SET  cat_name =:CatName, cat_details=:Details,cat_photo=:upic,link=:Link WHERE id=:uid');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add / Edit Service Category | <span> <a href="service-category"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
