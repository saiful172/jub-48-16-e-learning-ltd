...
<body>
  ...
  if (isset($_POST['btn_save_updates'])) {     
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE header_section SET title =:Title, subtitle=:SubTitle, link_one=:LinkOne, link_two=:LinkTwo, details=:Details, userPic=:upic WHERE id=7');
  ...
  ?>
        <script>
          ...
          window.location.href = 'faq-setting';
        </script>
  <?php
      } else {
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>FAQ Section | <span> <a href="faq"> <i class="bi bi-list"></i> Lists</a></h1>
      <hr>
    </div>
...
<?php
$banner = $DB_con->prepare('SELECT * FROM header_section WHERE id=7 ');
$banner->execute();
