...
<?php  require_once 'sidebar.php'; ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
     <h1>District |  <span> <a href="add-dist">   <i class="bi bi-plus-square-fill"></i> </a> </span> </h1>
       <hr>
    </div> 
          ...
          <div class="card">
			...
			?>
				<tr>
					...
					<td><a class="btn btn-info" href="edit-dist?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Do you want to Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>
