...
<body>
  ...
  if (isset($_GET['edit_id']) && !empty($_GET['edit_id'])) {
    ...
    $stmt_edit = $DB_con->prepare('SELECT * FROM gallery_video WHERE id =:uid');
  ...
  if (isset($_POST['btn_save_updates'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('UPDATE gallery_video 
									     SET title =:Title,
											  link =:Link,
										     userPic=:upic 
								       WHERE id=:uid');
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post" enctype="multipart/form-data" class="form-horizontal">
                ...
                <a class="btn btn-danger" href="gallery-video"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
