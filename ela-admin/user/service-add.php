...
<body>
  ...
  if (isset($_POST['btnsave'])) {
    ...
    if (!isset($errMSG)) {
      $stmt = $DB_con->prepare('INSERT INTO service (user_id,category_id,title,subtitle,details,userPic) 
															VALUES(:user_id,:category_id,:Title,:SubTitle,:Details,:upic)');
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Add New Service | <span> <a href="service"> <i class="bi bi-table"></i> </a> </span> </h1>
      <hr>
    </div>
