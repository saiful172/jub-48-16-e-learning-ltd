...
<body>
    ...
    if (isset($_GET['edit_id'])) {
        $eq = mysqli_query($con, "SELECT * FROM medical_admission  WHERE ad_id='" . $_GET['edit_id'] . "' ORDER BY ad_id desc   ");
    ...
    if (isset($_POST['btnsave'])) {
        ...
        if (!isset($errMSG)) {
            if ($ad_id == 0) {
                $stmt = $DB_con->prepare('INSERT INTO medical_admission (user_id,ad_name,ad_details,userPic) 
    ...
    ?>
                    <script>
                        ...
                        window.location.href = 'medical-admission';
                    </script>
                <?php
                } else {
                ...
                $stmt = $DB_con->prepare('UPDATE medical_admission 
									     SET  ad_name =:AdName,
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Add New Medical Diploma Course | <span> <a href="medical-admission"> <i class="bi bi-building"></i> </a> </span> </h1>
            <hr>
        </div>
