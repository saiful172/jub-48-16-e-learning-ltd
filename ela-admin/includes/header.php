<?php include('../dealer/session.php'); ?>
<?php include('../dealer/header.php'); ?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="navBrand"><a href="employee.php"><i class="glyphicon glyphicon-btc"></i> Employee</a></li>
          ...
          <li class="dropdown" id="navOrder1">
            ...
            <ul class="dropdown-menu">
              ...
              <li id="topNavManageOrder1"><a href="orders.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Manage Orders</a></li>
          ...
          <li class="dropdown" id="navOrder1">
            ...
            <ul class="dropdown-menu">
              <li id="topNavAddOrder1"><a href="expense.php?o=add"> <i class="glyphicon glyphicon-plus"></i> Expense</a></li>
              <li id="topNavManageOrder1"><a href="expense.php?o=manord"> <i class="glyphicon glyphicon-edit"></i> Manage Expense</a></li>
            </ul>
          </li>
