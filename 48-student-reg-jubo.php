          ...
          ?>
            <div class="alert alert-success p-2">
              <strong><span class="bi bi-check2-square"></span> <?php echo $successMSG; ?>
                <a target="_blank" class="btn btn-primary" style="float:right;" href="apply-pdf-48?view=<?php echo $Phone; ?>" title="Click For Print"><span class="bi bi-printer"></span> Print</a>
...
<div class="col-lg-12 mt-2" data-aos="fade-left">	
  ...
  -->
          ...
          <div class="shadow p-3 rounded">
            <center>
              <h5 class=""><strong><br>
                  ...
                  <span id="noticeSection" class="text-danger <?php echo $on;  ?>" style="line-height: 32px;">
                  ...
                  <span id="noticeSection" class="text-danger <?php echo $off;  ?>" style="line-height: 32px;">
                    <span style="font-size: 17px;">
            ...
            <form class="" id="myForm" method="post" enctype="multipart/form-data">
              ...
              <div class="form-row">
                ...
                <div class="col-md-6 form-group">
                  <?php
                  $query = $con48->query("SELECT * FROM division  ORDER BY div_id ASC");
    ...
    <input type="file" name="user_image" id="imageInput" accept="image/*">
    <div class="validate"></div>
    <img id="imagePreview" src="" alt="Image Preview" style="display: none; width: 150px; height: 150px; margin-top: 10px; border: 1px solid #ddd; padding: 5px;">
</div>
