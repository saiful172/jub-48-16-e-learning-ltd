...
<body>
<div class="container"> 
<center><h4><ol class="breadcrumb"> <li class="active">Trainer List </li></ol></h4></center>
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-primary" style="width:100%" href="trainer_add.php"> <span class="glyphicon glyphicon-plus"></span> Add New  </a> 
		</div>
...
<table width="100%" class="table table-hover" customer_id="dataTables-example">
                       ...
                       <tbody id="tbody">
							<?php
							$sl=0;
								$eq=mysqli_query($con,"select * from trainer where user_id='".$_SESSION['id']."' ORDER BY id DESC   ");
							...
							?>
										<tr>
											...
											<td><?php echo $eqrow['short_des']; ?></td>  
											
				<td><img src="trainer_images/<?php echo $eqrow['userPic']; ?>" width="50px" height="50px" /></td> 
             <td><a  class="btn btn-info" href="trainer_edit.php?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Are You Sure To Edit ?')"><span class="glyphicon glyphicon-edit"></span> Edit</a> </td>  
