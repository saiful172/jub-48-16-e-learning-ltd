...
<?php include('header.php'); ?>
 ...
 <section id="about-us" class="about-us p-0 mt-5 mt-5 ">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 mt-5 d-none">
...
<br><br><br>
  <div class="container mt-5 mt-5">
    ...
    <img class="rounded" src="../stu-info/user_images/<?php echo $userPic; ?>" height="150" width="150">
<?php else: ?>
    <img class="rounded" src="https://picsum.photos/id/237/200/300" height="150" width="150">
<?php endif; ?>
          ...
          <a href="student-income-details-gallery?student_id=<?= $student_id ?>" class="btn btn-success d-none">Earning Gallery</a>
