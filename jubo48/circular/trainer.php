...
<center><h4><ol class="breadcrumb"> <li class="active">Trainer List </li></ol></h4></center>
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-default" style="width:100%" href="trainer_add.php"> <span class="glyphicon glyphicon-plus"></span> Add New  </a> 
		</div>
...
<table width="100%" class="table table-hover" customer_id="dataTables-example">
                       ...
                       <tbody id="tbody">
							<?php
							$sl=0;
								$eq=mysqli_query($con,"select * from trainer  ORDER BY id DESC   ");
