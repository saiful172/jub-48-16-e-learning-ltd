...
<?php
	...
	{ 
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO trainer (user_id,name,designation,short_des,earn_market,about_trainer,link,userPic,entry_date) 
															VALUES(:user_id,:Name,:Desi,:ShortDes,:Earning,:About,:Link,:upic,NOW() )');
...
<center><h4><ol class="breadcrumb"> <li class="active"> Add New </li></ol></h4></center>
    	...
    	<h1 class="h2"><a class="btn btn-default" href="trainer_add.php"> <span class="glyphicon glyphicon-plus"></span> Add New  </a> <a class="btn btn-default" href="trainer.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View  </a></h1>
