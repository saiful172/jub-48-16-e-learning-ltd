            ...
            <table width="100%" class="table table-bordered table-hover text-center" id="testTableCount">
              ...
              <tbody id="tbody">
                ...
                if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                  ...
                  $sql = "SELECT  a.time, a.district, b.dist_name, a.div_id,d.div_name, COUNT(a.stu_id) as total_students 
                    FROM student_reg_jubo a 
                    LEFT JOIN division d ON a.div_id = d.div_id
                    LEFT JOIN district b ON a.district = b.id 
                    WHERE  time !='No' and entry_date >= '$start_date' AND entry_date <= '$end_date' 
                    GROUP BY a.district 
