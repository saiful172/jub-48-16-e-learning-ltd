...
<?php 
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO division (user_id,div_name) VALUES(:UserId,:DivName)');
...
<center><h4><ol class="breadcrumb"> <li class="active">  Division   </li></ol></h4></center>	
    	...
    	<h1 class="h2">&nbsp;<a class="btn btn-default" href="division_add.php"> <span class="glyphicon glyphicon-plus"></span>Add New</a> <a class="btn btn-default" href="division.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; View</a></h1>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal" >
   ...
   <tr>
	...
	<tr>
		...
		<td><input class="form-control" type="text" name="DivName" placeholder="Division Name"></td>
    </tr>
