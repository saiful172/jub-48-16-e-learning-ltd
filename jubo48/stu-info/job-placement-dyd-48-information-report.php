...
<head>
  ...
  <title>Job Placement Report | e-Learning & Earning Ltd.</title>
            ...
            <div class="col-12">
              <div class="page-title-box d-flex align-items-center justify-content-between">
                <div class="page-title">
                  ...
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">All Job Placement</li>
                  </ol>
                </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header border-bottom pt-5 pb-3 text-center">
                    ...
                    <h3> Student Job Placement List </h3>

                    <h3 class="m-0"> Job Placement List :
                      <?php
                      ...
                      <tbody>
                        ...
                        if ($_GET['dist_id'] == $_SESSION['id']) {
                          ...
                          if (isset($_GET['dist_id']) || isset($_GET['batch_id']) || isset($_GET['group_id'])) {
                            ...
                            if ($distId && $batch && $group) {
                              $sql = mysqli_query($con, "SELECT student_list.student_id, student_list.stu_name, student_list.father_name,student_list.contact,student_list.gender,student_list.userPic, job_placement_dyd_48.designation, job_placement_dyd_48.company_name, job_placement_dyd_48.salary FROM student_list 
                           
                             LEFT JOIN job_placement_dyd_48 ON job_placement_dyd_48.student_id = student_list.student_id
                        ...
                        ?>
                                <tr>
                                  ...
                                  <td><a href="job-placement-dyd-48-info-add?add_id=<?= $row['student_id']; ?>" target="_blank" class="btn btn-success"><i class="fas fa-briefcase me-2"></i>Add Job Placement</a></td>
                                </tr>
                          <?php
                              }
                            } else {
