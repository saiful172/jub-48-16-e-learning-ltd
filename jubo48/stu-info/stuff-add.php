      ...
      <div class="page-content">
        <div class="container-fluid">
          ...
          if (isset($_POST['btnsave'])) {
            ...
            if (!isset($errMSG)) {
              $stmt = $DB_con->prepare('INSERT INTO trainer (user_id, name, email, phone, type ,designation, joining_date, p_address, short_des, earn_market, about_trainer,link1, link2, link3, userPic, entry_date) 
															VALUES(:user_id, :Name, :Email, :Phone, :Type, :Desi, :JoiningDate, :PAddress, :ShortDes, :Earning, :About, :Link1, :Link2, :Link3, :upic, NOW() )');
