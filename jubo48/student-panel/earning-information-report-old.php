...
$eq = mysqli_query($con, "
  ...
  LEFT JOIN district ON district.id = certificate_info_dyd_48.district
  LEFT JOIN certificate_category ON certificate_category.batch_id = certificate_info_dyd_48.batch_id
  WHERE certificate_info_dyd_48.c_c_id = '$cid'
");

while ($eqrow = mysqli_fetch_array($eq)) {
  if ($_SESSION['id'] == $eqrow['user_id']) {
    $sl++;
?>
  <tr>
    <td><?= $sl; ?></td>
    ...
    <td>
      ...
      <a class="btn btn-danger waves-effect" href="?delete_id=<?= $eqrow['in_id']; ?>" onclick="return confirm('Are You Sure....?')"><i class="fa fa-trash me-2"></i>Delete</a>
    </td>
  </tr>
<?php
  }
