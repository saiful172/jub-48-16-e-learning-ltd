...
<head>
  ...
  <title>Add New Trainer | e-Learning & Earning Ltd.</title>
        ...
        <div class="container-fluid">
          ...
          ?>
                <script>
                  ...
                  window.location.href = 'trainer-add';
                </script>
          <?php
              } else {
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header border-bottom py-4">
                    <h4 class="card-title m-0">Add New Trainer</h4>
                  </div>
                  <div class="card-body">
                      ...
                      document.getElementById('phone').addEventListener('input', function () {
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Desi" placeholder="Designation" required />
                          </div>
                        </div>
                      </div>
                   <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <textarea cols="10" rows="2" class="form-control" name="PAddress" placeholder="Permanent Address" required></textarea>
                          </div>
                        </div>
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            <label class="control-label">Joining Date</label>
                            <input class="form-control" type="date" name="JoiningDate" placeholder="Joining Date" required />
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <textarea cols="10" rows="3" class="form-control" name="ShortDes" placeholder="Short Description"></textarea>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <textarea cols="10" rows="3" class="form-control" name="Earning" placeholder="Earning / Marketplace"></textarea>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-3">
                          <div class="form-group">
                            ...
                            <textarea cols="10" rows="4" class="form-control" name="About" placeholder="About Trainer"></textarea>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input type="file" name="user_image" id="user_image" accept="image/*" onchange="previewImage(event)" required />
                      ...
                      <script>
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="hidden" name="Type" placeholder="" value="trainer" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12 text-center">
                          <div class="form-group">
                            <a href="trainers" class="btn btn-danger waves-effect"><i class="fa fa-arrow-left me-2"></i>Back Now</a>
