...
<head>
  ...
  <title>Certificate Information | e-Learning & Earning Ltd.</title>
...
<body data-topbar="colored">
            ...
            <div class="col-12">
              <div class="page-title-box d-flex align-items-center justify-content-between">
                <div class="page-title">
                  ...
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item active">All Certificate Information</li>
                  </ol>
                </div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header border-bottom py-4">
                    <h4 class="card-title m-0">All Certificate Lists</h4>
                  </div>
                  <hr class="m-0">
                  <div class="card-body">
                    ...
                    <h3 class="text-center">Certificate List</h3>
  ...
  WHERE certificate_info_dyd_48.user_id = '" . $_SESSION['id'] . "' 
