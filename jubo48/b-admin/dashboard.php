      ...
      <div class="card alert alert-success mini-stat position-relative shadow p-0">
        <div class="card-body p-3">
          <div class="mini-stat-desc">
            <?php
            $sql = $con->query("SELECT count(`id`) as `total` FROM `trainer`");
            $row = $sql->fetch_assoc();
            ?>
	...
	<div class="col-xl-3 col-md-6">
      <div class="card alert alert-info mini-stat position-relative shadow p-0">
        <div class="card-body p-3">
          <div class="mini-stat-desc">
            <?php
            $sql = mysqli_query($con, "SELECT COUNT(*) AS total FROM student_list WHERE gender = 'male'");
            $row = $sql->fetch_assoc();
            ?>
	...
	<div class="col-xl-3 col-md-6">
      <div class="card alert alert-danger mini-stat position-relative shadow p-0">
        <div class="card-body p-3">
          <div class="mini-stat-desc">
            <?php
            $sql = mysqli_query($con, "SELECT COUNT(*) AS total FROM student_list WHERE gender = 'female'");
            $row = $sql->fetch_assoc();
            ?>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card alert alert-danger mini-stat position-relative shadow p-0">
        <div class="card-body p-3">
          <div class="mini-stat-desc">
          <?php
            $sql = mysqli_query($con, "SELECT SUM(`earning_dollar`) AS total FROM income_info");
            $row = $sql->fetch_assoc();
            ?>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card alert alert-success mini-stat position-relative shadow p-0">
        <div class="card-body p-3">
          <div class="mini-stat-desc">
          <?php
            $sql = mysqli_query($con, "SELECT SUM(`earning_bd`) AS total FROM income_info");
            $row = $sql->fetch_assoc();
            ?>
