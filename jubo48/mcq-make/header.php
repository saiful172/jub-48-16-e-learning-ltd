...
<div class="container">
   ...
   <li id="topNavUser"><a href="question-category.php"> <i class="glyphicon glyphicon-list"></i> Question Name</a></li> 
   <li id="topNavUser"><a href="question.php"> <i class="glyphicon glyphicon-th-list"></i> Question</a></li> 
   <li id="topNavUser"><a href="report-by-category.php"> <i class="glyphicon glyphicon-print"></i> Print</a></li>
