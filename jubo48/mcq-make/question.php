...
if (isset($_GET['delete_id'])) {
    $stmt_delete = $DB_con->prepare('DELETE FROM questions_make_list WHERE id =:id');
 ...
 <div style="width:100%" class="form-group input-group">
        ...
        <table width="100%" class="table  table-bordered table-responsive table-hover" group_id="dataTables-example">
            ...
            <tbody id="tbody">
                ...
                <?php
                $sl = 0;
                $sql = "SELECT questions_make_list.*, question_name.category 
                FROM questions_make_list
                JOIN question_name ON questions_make_list.category_id = question_name.id 
				where questions_make_list.status=1 and questions_make_list.user_id='" . $_SESSION['id'] . "'
                ...
                ?>
                    <tr>
                        ...
                        <td><a class="btn-sm btn-info" href="question-edit?edit_id=<?php echo $eqrow['id']; ?>" title="click for edit" onclick="return confirm('Do You Want To Edit ?')"><span class="glyphicon glyphicon-edit"></span> </a> </td>
