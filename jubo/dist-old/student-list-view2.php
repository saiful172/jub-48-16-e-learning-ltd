...
<form method="post" enctype="multipart/form-data" class="form-horizontal col-md-7">
    ...
    <tr>
	 ...
	 <tr>
        ...
        <a class="btn btn-success" href="student-list2.php"> <span class="glyphicon glyphicon-backward"></span> Back</a>
