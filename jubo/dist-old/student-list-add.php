...
<?php 
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO student_list(user_id,district,session,batch,stu_name,gender,father_name,mother_name,birth_date,age,contact,email,nid_no,blood_grp,computer,profession,religion,disabilities,address,perma_address,edu_qual,pass_year,linked_in,upwork,fiver,link_three,link_four,join_date,status,userPic)
			VALUES(:UserId,:District,:Session,:Batch,:StuName,:Gender, :FatherName, :MotherName,:Dob,:Age,:Contact,:Email,:NidNo,:BloodGrp,:Computer,:Profession,:Religion,:Disabilities,:Address,:PermaAddress,:EduQual,:PassYear,:LinedIn,:Upwork,:Fiverr,:LinkThree,:LinkFour,:Date,1,:upic)');
