    ...
    <form method="post" enctype="multipart/form-data" class="form-horizontal">
      ...
      <table class="table table-hover table-responsive">
        ...
        <tr>
          ...
          <td><Select class="form-control" type="text" name="Group" required>
        ...
        <tr>
          ...
          <td><textarea style="height:90px; width:100%;" class="form-control" name="About" placeholder="About / Objective"></textarea></td>
        </tr>
        ...
        <tr>
          ...
          <td><input class="form-control" type="date" name="Dob" value="<?php date_default_timezone_set("Asia/Dhaka");
  ...
  <script>
    $("#loadGroup").on("click", function() {
      ...
      if (groupID == "") {
        ...
        $.ajax({
          url: "ajax_c_load_group.php?c=" + groupID,
