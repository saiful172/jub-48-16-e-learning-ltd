...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
        ...
        <td><textarea style="height:90px; width:100%;" class="form-control" name="About" placeholder="About Trainer" ><?php echo $about; ?></textarea></td>
    </tr>
    ...
    <tr>
	 ...
	 <tr>
        ...
        <a class="btn btn-danger" href="student-list2.php"> <span class="glyphicon glyphicon-backward"></span> Cancel</a>
