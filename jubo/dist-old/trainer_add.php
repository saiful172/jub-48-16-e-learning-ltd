...
<form method="post" enctype="multipart/form-data" class="form-horizontal" >
   ...
   <tr>
	...
	<tr>
        ...
        <td><input class="form-control" type="text" name="Link1" placeholder="Freelancing  Link 01" value="None" /></td>
   </tr>
   
   <tr>
    	<td><label class="control-label"> Freelancing  Link 02</label></td>
        <td><input class="form-control" type="text" name="Link2" placeholder="Freelancing  Link 02" value="None"/></td>
   </tr>
   
   <tr>
    	<td><label class="control-label"> Freelancing  Link 03</label></td>
        <td><input class="form-control" type="text" name="Link3" placeholder="Freelancing  Link 03" value="None" /></td>
   </tr>
