...
<?php 
	...
	if(isset($_POST['btnsave']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO student_list(user_id,district,session,batch,stu_name,about,work,gender,father_name,mother_name,birth_date,age,contact,email,nid_no,blood_grp,computer,profession,religion,disabilities,address,perma_address,edu_qual,pass_year,linked_in,upwork,fiver,link_three,link_four,join_date,status,userPic)
			VALUES(:UserId,:District,:Session,:Batch,:StuName,:About,:Work,:Gender, :FatherName, :MotherName,:Dob,:Age,:Contact,:Email,:NidNo,:BloodGrp,:Computer,:Profession,:Religion,:Disabilities,:Address,:PermaAddress,:EduQual,:PassYear,:LinedIn,:Upwork,:Fiverr,:LinkThree,:LinkFour,:Date,1,:upic)');
         ...
         <script>
				...
				window.location.href='student-list2.php';
				</script>
          <?php			
...
<form method="post" enctype="multipart/form-data" class="form-horizontal" >
   ...
   <tr>
	...
	<tr>
        ...
        <td><textarea style="height:90px; width:100%;" class="form-control" name="Work" placeholder="Work Experience" ></textarea></td>
    </tr>
	...
	<tr>
		...
		<td><input class="form-control" type="date" name="Dob"   value="<?php date_default_timezone_set("Asia/Dhaka"); echo date("Y/m/d") ;?>" required></td>
    </tr>
...
  		 <td>   
		...
		<input type="radio"   name="Disabilities" value="No" checked> No
		</td>
    </tr>
	...
	<tr>
        ...
        <td><input class="form-control" type="text" name="LinedIn" placeholder="LinkedIn Link" value="none" required></td>
    </tr>
	
	<tr>
    	<td><label class="control-label">Up-Work </label></td>
        <td><input class="form-control" type="text" name="Upwork" placeholder="Upwork Link"  value="none" required></td>
    </tr>
	
	<tr>
    	<td><label class="control-label">Fiver </label></td>
        <td><input class="form-control" type="text" name="Fiverr" placeholder="Fiverr Link"  value="none" required></td>
    </tr>
	
	<tr>
    	<td><label class="control-label">Other Freelancing Link 1 </label></td>
        <td><input class="form-control" type="text" name="LinkThree" placeholder="Freelancing Link 3 "  value="none"  required></td>
    </tr>
	
	<tr>
    	<td><label class="control-label">Other Freelancing Link 2 </label></td>
        <td><input class="form-control" type="text" name="LinkFour" placeholder="Freelancing Link 4 " value="none"  required></td>
    </tr>
