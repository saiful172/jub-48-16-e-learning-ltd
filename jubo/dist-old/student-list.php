...
<center><h4><ol class="breadcrumb"> <li class="active">Student List </li></ol></h4></center>
	...
	<div class="buttons">
		...
		<div class="col-md-2">
		<a class="btn btn-primary" style="width:100%" href="student-list-add.php"> <span class="glyphicon glyphicon-plus"></span> Add New Student </a> 
		</div>
		
		<div class="col-md-2">
		<a class="btn btn-success" style="width:100%" href="student-list1.php"> <span class="glyphicon glyphicon-plus"></span> Batch-01 </a> 
		</div>
		
		<div class="col-md-2">
		<a class="btn btn-success" style="width:100%" href="student-list2.php"> <span class="glyphicon glyphicon-plus"></span> Batch-02 </a> 
		</div>
...
<table width="100%" class="table table-bordered table-hover" student_id="dataTables-example">
                       ...
                       <tbody id="tbody">
							<?php
							$sl=0;
								$eq=mysqli_query($con,"select * from student_list where user_id='".$_SESSION['id']."'  ORDER BY student_id DESC ");
				...
				<td><a  class="btn btn-info" href="student-list-view.php?edit_id=<?php echo $eqrow['student_id']; ?>" title="Click To View" ><span class="glyphicon glyphicon-eye-open"></span> View</a> </td>
