  ...
  <div class="row">
        ...
        <div class="card-body p-3">
          <div class="mini-stat-desc">
            ...
            <div class="text-white mt-2">
              ...
              <h3 class="text-white"><?= str_pad($row['total'], 2, 0, STR_PAD_LEFT) ?></h3>
            </div>
			
            <div class="mini-stat-icon">
              <i class="mdi mdi-account-group mt-2"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Male Students </h5>
            ...
            <div class="mini-stat-icon">
              <i class="mdi mdi-human-male display-2"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Female Students </h5>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Dollar Earning </h5>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">BD Tk Earning </h5>
            ...
            <div class="mini-stat-icon">
              <i class="mdi mdi-currency-bdt display-2"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Jobs </h5>
            ...
            <div class="mini-stat-icon">
              <i class="mdi mdi-tag-multiple display-2"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Baches </h5>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Payment Method </h5>
            ...
            <div class="mini-stat-icon">
              <i class="mdi mdi-contactless-payment display-2"></i>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-3 col-md-6">
      <div class="card bg-success mini-stat position-relative shadow">
        <div class="card-body">
          <div class="mini-stat-desc">
            <h5 class="text-uppercase verti-label font-size-16 text-white-50">Work Source </h5>
            ...
            <div class="mini-stat-icon">
              <i class="mdi mdi-check-network display-2"></i>
            </div>
          </div>
        </div>
      </div>
