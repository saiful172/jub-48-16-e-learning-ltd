                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="Desi" value="<?php echo $designation; ?>" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          <div class="form-group">
                            ...
                            <p><img src="trainer_images/<?php echo $userPic; ?>" class="img-fluid img-thumbnail rounded-circle" style="width: 120px; height: 120px;" /></p>
