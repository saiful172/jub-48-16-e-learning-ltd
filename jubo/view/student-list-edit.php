...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
	...
	<tr>
        ...
        <td><Select class="form-control" type="text" name="District" >
...
  		<label for=""><?php echo $computer; ?></label><br>
		<input type="radio"   name="Computer">
...
  		<label for="no">No</label>
	...
	<tr>
        ...
        <td><input class="form-control" type="text" name="Religion" value="<?php echo $email; ?>"  /></td>
    </tr>
...
  		<label for=""><?php echo $disabilities; ?></label><br>
		<input type="radio"   name="Disabilities">
