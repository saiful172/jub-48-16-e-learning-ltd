			...
			elseif($lrow['access_level']=="2")
              ...
              <?php
				...
				?>
					...
					<script>
						window.alert('Welcome To Question Bank');
						window.location.href='mcq-view/';
					</script>
					
					
					<?php
				}
				elseif($lrow['access_level']=="8")
				{
				$_SESSION['id']=$lrow['userid'];
				...
				?>
					<script>
						window.alert('Welcome To Question Bank');
						window.location.href='mcq-make/';
					</script>
					
			  <?php
				}
			elseif($lrow['access_level']=="9")
				{
				$_SESSION['id']=$lrow['userid'];				
				?>
				
					<script>
						window.alert('Welcome To Certificate Panel!');
						window.location.href='certificate/index.php';
					</script>		
					
					
					<?php
				}
				elseif($lrow['access_level']=="41")
				{
				$_SESSION['id']=$lrow['userid'];
				...
				?>
					...
					<script>
						window.alert('Welcome To Frelancer Data');
