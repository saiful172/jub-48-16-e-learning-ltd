...
if (isset($_GET['delete_id'])) {
    $stmt_delete = $DB_con->prepare('DELETE FROM question_name WHERE id =:id');
...
<div class="container">
    <center>
     ...
     <div class="buttons">
        <div class="col-md-2">
            <a class="btn btn-primary text-black" href="question-category-add"> <span class="glyphicon glyphicon-plus"></span> Add New Question Name </a>
        </div>
      </div>
        ...
        <table width="100%" class="table  table-bordered table-responsive table-hover" group_id="dataTables-example">
            ...
            <tbody id="tbody">
                ...
                <?php
                $sl = 0;
                $eq = mysqli_query($con, "select * from question_name where user_id='" . $_SESSION['id'] . "'  ORDER BY id DESC ");
