...
if (isset($_POST['save'])) {
    ...
    if ($id == '0') {
        ...
        if (!isset($errMSG)) {
            $stmt = $DB_con->prepare('INSERT INTO questions_make_list (user_id, category_id, question, ans1, ans2, ans3, ans4, status)VALUES(:user_id,:category_id,:question,:ans1,:ans2,:ans3,:ans4, 1)');
